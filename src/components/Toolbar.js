    ...
    return (        
        <div className="app-toolbar">
            ...
            <>
                ...
                {currentMenu === MENUTYPE.INNUDATEANALYSIS ?
                <InnudateAnalysis 
                    viewer={viewer} 
                    show={currentMenu === MENUTYPE.INNUDATEANALYSIS}
                    closeMenu={()=>SetCurrentMenu(MENUTYPE.NONE)}></InnudateAnalysis> : null}
            </>
            <>
                ...
                {currentMenu === MENUTYPE.DRAWVIEWER ?
                <DrawViewer 
                    viewer={viewer} 
                    show={currentMenu === MENUTYPE.DRAWVIEWER}
                    closeMenu={()=>SetCurrentMenu(MENUTYPE.NONE)}></DrawViewer> : null}
            </>
        </div>
    );
}